...
<div style="display: flex; justify-content: center;">
	<table style="margin: 0 auto;">
		...
		<tbody>
			...
			<tr><td>Matheus Rodrigues</td><td>Colaboração durante o brainstorming e elaboração da etapa Decide (1.1.3)</td></tr>
...
Como entrega final desta etapa, as melhores ideias foram consolidadas em um _storyboard_ autossuficiente. Este esboço demonstra o fluxo de interação do usuário passo a passo:
...
![Storyboard do Widget de Acessibilidade](assets/artefato-generalista/storyboard.png)
_Figura 01 — Membro: [Dara Maria](https://github.com/daramariabs)_
...
| `1.4`  | 04/04/2026 | Elaboração da etapa 1 (Unpack) da design sprint        |     [Enzo Fernandes](https://github.com/enzo-fb)     |
| `1.5`  | 05/04/2026 | Melhoria da seção Unpack e ajustes na etapa Decide     | [Matheus Rodrigues](https://github.com/mrodrigues14) |
